...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsVoteVoteComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_votes_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
       ...
       */
      function AppComponent(votesService, snackBar) {
      ...
      */
      ...
      _createClass(AppComponent, [{
        ...
        value: function login() {
          var config = this.votesService.getConfig();
          if (config.pwd === this.form.value.pwd) this.loginOk = true;else this.snackBar.open('Contraseña Incorrecta', 'Cerrar', {
            duration: 2000
          });
        }
        /**
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_vote_vote_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _services_votes_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./services/votes.service */
    "./src/app/services/votes.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _components_vote_vote_component__WEBPACK_IMPORTED_MODULE_4__["VoteComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"], _components_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_8__["DialogComponent"], _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_9__["AdminComponent"]],
      entryComponents: [_components_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_8__["DialogComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], // mat
      _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatCardModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatToolbarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialogModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatTableModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatSnackBarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatIconModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatTooltipModule"]],
  ...
  function srcAppComponentsAdminAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_votes_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/services/votes.service */
    "./src/app/services/votes.service.ts");
    /* harmony import */
    ...
    var AdminComponent = /*#__PURE__*/function () {
       ...
       */
      function AdminComponent(votesService, dialog) {
      ...
      _createClass(AdminComponent, [{
        ...
        value: function getCandidates() {
          ...
          this.candidates.map(function (c) {
            return _this.totalVotes += c.votes;
          });
        }
        /**
        ...
        value: function reset() {
          ...
          var dialog = this.dialog.open(_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_4__["DialogComponent"], {
            data: {
              template: 'reset'
            }
          });
          var subs = dialog.afterClosed().subscribe(function (confirm) {
            subs.unsubscribe();
            if (!confirm) return;

            _this2.votesService.reset();
  ...
  function srcAppComponentsDialogDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"]))], DialogComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsVoteVoteComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsVoteVoteComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var VoteComponent = /*#__PURE__*/function () {
      function VoteComponent(votesService, dialog) {
      ...
      _createClass(VoteComponent, [{
        key: "addVote",
        value: function addVote(candidate) {
          var _this3 = this;
          ...
          var subs = dialog.afterClosed().subscribe(function (confirm) {
            ...
            _this3.votesService.addVote(candidate);
          });
        }
      }]);
    ...
    VoteComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/vote/vote.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./vote.component.scss */
      "./src/app/components/vote/vote.component.scss")).default]
    })], VoteComponent);
    /***/
  },
  ...
  function srcAppInterfacesInterfacesTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "CandidateWhite", function () {
  ...
  /***/
  function srcAppServicesVotesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "KEY_JSON", function () {
      return KEY_JSON;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "VotesService", function () {
      return VotesService;
    });
    /* harmony import */
    ...
    var KEY_JSON = hashCode('app-elections');
    var KEY_CONFIG = hashCode('app-config');

    var VotesService = /*#__PURE__*/function () {
      function VotesService() {
        _classCallCheck(this, VotesService);
      ...
      _createClass(VotesService, [{
        ...
        value: function getConfig() {
          var data = this.getData(KEY_CONFIG);
        ...
        key: "getCandidates",
        value: function getCandidates() {
          var data = this.getData(KEY_JSON);
          if (data) this.candidates = JSON.parse(data);else this.candidates = [_interfaces_interfaces__WEBPACK_IMPORTED_MODULE_2__["CandidateWhite"], {
            id: 1,
            names: 'Valentina',
            votes: 0,
            img: 'vote1.jpeg'
        ...
        value: function getData(key) {
          if (src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].production) return localStorage.getItem(key);else return null;
        }
        /**
         * Adds vote
         * @param candidate
        ...
        value: function addVote(candidate) {
          ...
          var index = this.candidates.findIndex(function (c) {
            return c.id == candidate.id;
          });
          if (index >= 0) this.candidates[index].votes++;
          localStorage.setItem(KEY_JSON, JSON.stringify(this.candidates));
          this.inVote = true;
          setTimeout(function () {
            return _this4.inVote = false;
          }, 5000);
        }
      }]);
    ...
    VotesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], VotesService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /var/www/html/angular/app-elections/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
